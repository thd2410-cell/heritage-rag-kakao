...
FOLLOWUP_HINTS = [
    ...
    "깊게", "구체", "풀어서", "더 풀", "더풀", "길게", "더 길", "더길",
    "쉽게", "다시 설명", "다시설명", "예시", "예를", "이어서", "계속", "그거", "그 유산", "방금",
]
TOPIC_SHIFT_HINTS = ["알려줘", "설명", "뭐야", "무엇", "어때", "추천"]
RETURN_TOPIC_HINTS = ["아까", "이전", "전에", "방금 전", "방금전"]
ROOT_TOPIC_HINTS = ["처음", "원래", "처음에", "처음 말한", "처음말한"]
CONTEXTUAL_HINTS = [
    "건축", "구조", "형태", "공간", "역사", "시대", "의미", "중요", "왜", "이유", "특징", "가치",
    "인물", "왕", "누가", "어디", "위치", "주소", "근처", "주변", "행사", "답사", "여행", "가는",
    "볼만", "화재", "복원", "전설", "이야기", "유래", "어떻게", "언제", "몇", "차이", "비교",
    "만든", "지은", "보관", "공개", "사진", "이미지", "입장", "관람", "동선", "코스", "소요", "시간", "볼거리",
]
REFERENCE_HINTS = FOLLOWUP_HINTS + RETURN_TOPIC_HINTS + ROOT_TOPIC_HINTS + ["이거", "저거", "이 유산", "저 유산", "이것", "저것"]
